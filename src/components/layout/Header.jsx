...
import { FaSignOutAlt, FaUser, FaSearch, FaTimes, FaBook, FaBell, FaHeart, FaClipboardList, FaBookReader, FaUserCircle, FaChartBar, FaMoneyBillAlt } from 'react-icons/fa';
  ...
  return (
    <nav className="navbar">
      <div className="nav-left">
        <Link to="/home" className="logo"> <img src="https://ptit.edu.vn/wp-content/uploads/2024/09/circle-ptit-2.webp" alt="PTIT Logo" className="logo-img" /></Link>
      ...
      <div className="nav-right">
        ...
        <div className="nav-icons">
          ...
          <div className="user-profile" onClick={() => setShowUserMenu(!showUserMenu)} ref={userMenuRef}>
            <FaUser className="icon" />
            <span className="user-name">{user?.user?.full_name}</span>
            {showUserMenu && (
