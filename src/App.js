...
const AppContent = () => {
  ...
  useEffect(() => {
    ...
    handleStart();
    const timer = setTimeout(handleComplete, 500); // Giả lập thời gian tải
  ...
  return (
    <>
      ...
      <Routes>
        ...
        />
        <Route path="/services" element={<MainLayout><ServiceList /></MainLayout>} />
        <Route 
          path="/services/add" 
          element={
            <AdminRoute>
        ...
        />
        <Route path="/categories" element={<MainLayout><CategoryList /></MainLayout>} />
        <Route 
          path="/categories/add" 
          element={
            <AdminRoute>
        ...
        />
        <Route path="/rules" element={<MainLayout><RuleList /></MainLayout>} />
        <Route 
        ...
        />
        <Route path="/favorites" element={<MainLayout><FavoriteBooks /></MainLayout>} />
